window.STUDY_DATA = {
  "Afghanistan": {
    ...
    "translation_ja": "この地はアフガニスタン、\nそれはすべてのアフガニスタン人の誇りです。\n平和の国、剣の国、\nその息子たちはそれぞれ勇敢です。"
  },
  "Albania": {
    ...
    "translation_ja": "私たちの旗の周りで私たちは団結します、\n一つの意志と一つの願いで、\n神聖な誓いが今宣言されている、\n私たちの救いが切望されるためです。\n\nそれらの人だけが闘争を避けられますように。\n私たちの法律に背く者たち、\nUndaunted は徹底的なヒーローです、\n彼は大義に対して殉教者として死ぬ。"
  },
  "Argentina": {
    ...
    "translation_ja": "定命の者よ、神聖な叫びを聞いてください。\n自由だ！自由！自由！\n壊れた鎖の音を聞く\n即位した高貴な平等を参照してください。"
  },
  "Armenia": {
    "anthem": "Mer Hayrenik",
    "native": "Մեր Հայրենիք",
    ...
    "translation_ja": "自由で独立した私たちの祖国、\nそれは何世紀も何世紀にもわたって生きてきた\nその息子たちが今電話をかけています\n自由で独立したアルメニア。"
  },
  "Australia": {
    ...
    "translation_ja": "オーストラリア人は皆、私たちを喜ばせてくれます。\nなぜなら、私たちは一つであり、自由だからです。\n私たちには、苦労に見合った黄金の土壌と富があります。\n私たちの家は海に囲まれています。"
  },
  "Azerbaijan": {
    ...
    "translation_ja": "アゼルバイジャン！アゼルバイジャン！\nおお、勇敢な子供たちの輝かしい祖国よ！\n私たちは皆、あなたのために命を捧げる準備ができています!\n私たちは皆、あなたたちのために血を流す準備ができています。"
  },
  "Bangladesh": {
    ...
    "translation_ja": "私の黄金のベンガル、私はあなたを愛しています。\n永遠にあなたの空、あなたの空気が、まるでフルートのように私の心を同調させます。"
  },
  "Belarus": {
    "anthem": "My Belarusy",
    "native": "Мы, беларусы",
    ...
    "translation_ja": "私たちベラルーシ人は平和な人々です。\n心を込めて祖国を愛し、\n私たちは力を合わせて誠実な友達です\n私たちの勤勉で自由な家族。"
  },
  "Belgium": {
    ...
    "translation_ja": "おおベルギーよ、親愛なる母よ、\nあなたに私たちの心、あなたに私たちの腕、\n私たちの血よ、祖国よ！\n私たちは皆、誓います、あなたは生きなければなりません！\n\nあなたは常に素晴らしく美しく生きるでしょう。\nそしてあなたの無敵の団結\n不滅のモットーとして持つべきもの:\n王、法、自由！"
  },
  "Bhutan": {
  ...
  "Bolivia": {
    ...
    "translation_ja": "ボリビア人、幸運な運命\nついに私たちの誓いと憧れを飾りました。\nこの土地は自由だ、ついに自由だ。\nその奴隷状態は今、ようやく終わった。\n\n祖国の崇高な名前を守りましょう\n輝かしい素晴らしさの中で。\nそして、その祭壇の上で、私たちはもう一度誓わなければなりません。\n奴隷として生きる前に死ぬなんて！"
  },
  "Bosnia Herzegovina": {
  ...
  "Brazil": {
    ...
    "translation_ja": "イピランガ川の静かな岸辺が聞こえた\n英雄的な民の響き渡る叫び、\nそして、自由の太陽が、輝く光の中で、\nその瞬間、祖国の空に輝いた。"
  },
  "Bulgaria": {
    "anthem": "Mila Rodino",
    "native": "Мила Родино",
  ...
  "Brunei": {
    ...
    "translation_ja": "おおアッラーよ、陛下を祝福してください\n長寿命で\n公正かつ主権を持って土地を統治する\n人々を永遠の幸福に導く"
  },
  "Cambodia": {
    "anthem": "Nokor Reach",
    "native": "បទនគររာជ",
  ...
  "Canada": {
    ...
    "translation_ja": "おお、カナダよ！私たちの故郷であり、故郷です！\n私たち全員の中にある真の愛国者愛が命令されています。\n輝く心とともに、私たちはあなたが立ち上がるのを見ます、\n真の北は強くて自由です！"
  },
  "Chad": {
    ...
    "translation_ja": "チャドの人々よ、立ち上がって働け！\nあなたは自分の土地と権利を征服しました。\nあなたの自由はあなたの勇気から生まれます。\n目を上げて、未来はあなたのものです。"
  },
  "Chile": {
    ...
    "translation_ja": "純粋なチリはあなたの青い空です、\n清らかな風もあなたを横切ります、\n花の刺繍が施されたあなたの畑、\nエデンの幸せなコピーです。\n\nSweet Homeland、誓いを受け取ってください\nチリはあなたの祭壇でこう誓った。\nあなたは自由の墓のどちらかになるだろう\nまたは抑圧からの避難所。"
  },
  "China": {
    ...
    "translation_ja": "起きろ！奴隷になることを拒む者よ！\n私たちの血肉を新しい万里の長城にしましょう!\n中国国家が最大の危機に直面する中、\n全員が最後の叫びを力強く吐き出す。"
  },
  "Colombia": {
  ...
  "Croatia": {
    ...
    "translation_ja": "私たちの美しい故郷、\nああ、なんと恐れ知らずで慈悲深いのでしょう、\n私たちの先祖たちの古代の栄光、\n永遠に祝福されますように。\n\n親愛なる、あなたは私たちの唯一の栄光です、\n親愛なる、あなたは私たちにとって唯一の人です、\n親愛なる、私たちはあなたの平原を愛しています、\n親愛なる皆さん、私たちはあなたの山が大好きです。"
  },
  "Cuba": {
    ...
    "translation_ja": "バヤモの男たちよ、戦いに走れ！\n祖国は誇りを持ってあなたを見つめています。\n輝かしい死を恐れるな、\n祖国のために死ぬことは生きることだから。\n\n鎖の中で生きることは生きることだ\n恥辱と恥辱にまみれた。\nラッパの音を聞いてください。\n武器を持って、勇敢な者たちよ、走れ！"
  },
  "Czech Republic": {
    ...
    "translation_ja": "私の家はどこですか、私の家はどこですか？\n水が草原を轟音を立てて流れ、\n松の木が岩の間でざわめき、\n果樹園は春の花できらめき、\n見るべき地上の楽園！"
  },
  "Denmark": {
  ...
  "Estonia": {
    ...
    "translation_ja": "私の故郷、私の喜びと喜び、\nあなたはなんて公平なんだろう――なんて明るいんだろう！\n世界中のどこにもない、\n果たしてそんな場所が見つかるだろうか、\nとても愛されていて、深い感覚から、\n親愛なる私の祖国よ！"
  },
  "Ethiopia": {
    ...
    "translation_ja": "私たちのエチオピアでは市民権の尊重が強いです。\n国民の誇りが端から端まで輝いて見えます。\n平和のために、正義のために、人々の自由のために、\n平等と愛において、私たちは団結します。"
  },
  "Finland": {
    "anthem": "Maamme",
    ...
    "translation_ja": "私たちの土地、私たちの土地、私たちの祖国、\n大声で言え、おお価値ある名よ！\n天のバンドに匹敵する山はない、\n隠れた谷も波に洗われた波もなし、\n私たちの故郷である北部と同じように、愛されています。\n私たちの先祖たちの地球。"
  },
  "France": {
  ...
  "Hungary": {
    ...
    "translation_ja": "おお神よ、ハンガリー国民に祝福あれ\nあなたの恵みと恩恵とともに。\n守っている腕をその上に伸ばしてください\n敵との争い中。\n長く悪しき運命に引き裂かれ、\n安らぎのひと時をお届けします。\nこの国はあらゆる罪のために苦しんできた\n過去も未来も！"
  },
  "Iceland": {
    "anthem": "Lofsongur",
    "native": "Lofsöngur",
  ...
  "India": {
    ...
    "translation_ja": "あなたはすべての人々の心の支配者であり、\nインドの運命を司る者。\nあなたの名前はパンジャーブ州、シンド州、グジャラート州、マラーター州の心を呼び起こします。\nドラビダ、オリッサ、ベンガル出身。"
  },
  "Indonesia": {
  ...
  "Ireland": {
    ...
    "translation_ja": "兵士とは我々である、\n彼らの命はアイルランドに約束されています。\n何人かが来ました\n波の向こうの地から、\n自由になることを誓い、\nもう私たちの古代の島ではありません。\n専制君主か奴隷を保護するものとする。"
  },
  "Israel": {
    "anthem": "Hatikvah",
    "native": "הַתִּקְוָה",
  ...
  "Jamaica": {
    ...
    "translation_ja": "永遠の父よ、私たちの土地を祝福してください、\nあなたの力強い御手で私たちを守ってください、\n私たちを邪悪な力から解放してください、\n数え切れないほどの時間をかけて私たちの光になってください。"
  },
  "Japan": {
    "anthem": "Kimigayo",
    "native": "君が代",
    ...
    "translation_ja": "あなたの統治がなされますように、\n千代、八千代まで続いて、\n小石まで\n岩に成長する\n苔が生い茂る。"
  },
  "Jordan": {
    ...
    "translation_ja": "王様万歳！王様万歳！\n彼の地位は崇高であり、彼の旗は最高の栄光に翻っています。\nおおアラブの王よ、あなたが持つ最高の預言者より。\n王朝の栄誉、本の奥底で語られる！"
  },
  "Kazakhstan": {
  ...
  "Kenya": {
    ...
    "translation_ja": "おお、すべての創造の神よ\n私たちの土地と国家に祝福あれ\n正義が私たちの盾となり擁護者となってください\n私たちが団結して住めますように"
  },
  "Kyrgyzstan": {
    ...
    "translation_ja": "白い帽子をかぶった岩の崖と草原\n私たちの人々の魂と同じくらい平等です。\n数え切れないほどの世紀の輪の中で保存され、\n彼らは私たちの人々を自由に導きます。"
  },
  "Laos": {
    ...
    "translation_ja": "常にラオスの人々は祖国を讃えてきました。\n心、精神、活力が一つに結ばれます。"
  },
  "Latvia": {
  ...
  "Lithuania": {
    ...
    "translation_ja": "私たちの祖国、リトアニア、\n英雄の国、\nあなたの息子たちが力を引き出せますように\n過去から。\n\nお子様が歩けますように\n美徳の道においてのみ、\n彼らがあなたの利益のために働きますように\nそして人々の利益のために。"
  },
  "Luxembourg": {
    "anthem": "Ons Heemecht",
    "native": "Ons Heemecht",
    ...
    "translation_ja": "アルゼット川が草原を流れるところ、\nスーラは岩山を突き破り、\nモーゼル川沿いにブドウの木が香り高く咲く場所、\n天は私たちにワインを与えてくれます。\n\n私たちが深く背負っている故郷\n私たちの心の中に。"
  },
  "Madagascar": {
  ...
  "Malta": {
    ...
    "translation_ja": "この美しい土地へ、私たちに名前を与えてくれた母よ、\n主よ、あなたがいつも彼女を見守ってくださったように、彼女を見守ってください。\n私たちが愛する土地よ、あなたに敬意を表します。\nおお、私たちが愛する土地よ、私たちのマルタ！"
  },
  "Mexico": {
    ...
    "translation_ja": "メキシコ人は、戦争の叫び声の中で、\n鋼鉄と手綱を準備し、\nそして地球がその中心で震えますように\n鳴り響く大砲の轟音に。"
  },
  "Moldova": {
  ...
  "Morocco": {
    ...
    "translation_ja": "自由の泉、光の源、\n主権と安全が交わる場所では、\n安全と主権を組み合わせることができますように!\nあなたは崇高な称号を持って国々の間で生きてきました。"
  },
  "Myanmar": {
    "anthem": "Kaba Ma Kyei",
    "native": "ကမ္ဘာမကျေ",
    ...
    "translation_ja": "世界が終わるまで、私たちはミャンマーを愛します。\nそれは私たちの先祖から受け継がれた真の遺産であり、\n私たちはそれを愛し、大切にしています。"
  },
  "Nepal": {
    ...
    "translation_ja": "私たちは何百もの花、一つの花輪 – ネパール人、\n主権者、メチからマハーカリまで広がっています。"
  },
  "Netherlands": {
    "anthem": "Wilhelmus",
    "native": "Wilhelmus",
  ...
  "New Zealand": {
    ...
    "translation_ja": "諸国民の神があなたの足元におられますように、\n出会う愛の絆の中で、\n私たちの声を聞いてください、私たちは懇願します、\n神は私たちの自由な土地を守ってくださいます。"
  },
  "Nicaragua": {
    ...
    "translation_ja": "万歳、ニカラグア！あなたの土壌の上で\n大砲の声はもう轟かず、\n兄弟の血も染まらない\nあなたの輝かしい二色のバナー。"
  },
  "Nigeria": {
  ...
  "North Korea": {
    ...
    "translation_ja": "この地の銀と金に朝が輝きますように、\n自然の豊かさが詰まった三千リーグ、私の美しい祖国。\n輝かしい歴史の文化に育まれた賢者の栄光\n五千年も続くこの栄光。"
  },
  "Norway": {
    ...
    "translation_ja": "はい、私たちはこの国を愛しています\nそれが立ち上がるにつれて、\n険しい、風化した、水の上、\n千の家と一緒に。\n\n愛して、愛して、考えて\n私たちの父と母の\nそして横たわるサーガの夜\n私たちの地球に夢を。"
  },
  "Pakistan": {
  ...
  "Peru": {
    ...
    "translation_ja": "私たちは自由です、永遠にそのままでいよう、\nそして太陽がその光をむしろ否定するようにしましょう\nそんなことより私たちは厳粛な誓いを果たせないはずです\n私たちの祖国はそれを永遠のものに育てました。"
  },
  "Philippines": {
  ...
  "Romania": {
    ...
    "translation_ja": "目覚めよ、ルーマニア人よ、死の眠りから\nあなたは野蛮な暴君たちによってその中に沈められました！\n今、あるいは決してしないで、自分自身のために新しい運命を作りましょう。\nこれには残酷な敵も屈服するでしょう！"
  },
  "Russian Federation": {
    ...
    "translation_ja": "ロシアは私たちの神聖な国家です、\nロシアは私たちの愛する国です。\n強大な意志、偉大な栄光――\nあなたの尊厳をいつまでも！"
  },
  "Saudi Arabia": {
  ...
  "Serbia": {
    ...
    "translation_ja": "正義の神。私たちを救ってくださったあなた\n破壊から現在に至るまで、\nセルビアの子供たちの声を聞いてください。\nそしてこれからも私たちの力になってください。"
  },
  "Slovakia": {
  ...
  "Slovenia": {
    ...
    "translation_ja": "すべての国々に神の祝福がありますように。\nその輝かしい日を待ち望んで働く人は、\n地球上の居住地にいるとき\nいかなる戦争や紛争も影響を及ぼしません。"
  },
  "South Africa": {
    ...
    "translation_ja": "アフリカに神のご加護がありますように、\n彼女の栄光が高く掲げられますように、\n私たちの嘆願を聞いてください、\nあなたの子供たちよ、神のご加護がありますように。"
  },
  "South Korea": {
    "anthem": "Aegukga",
    "native": "애국가",
    ...
    "translation_ja": "白頭山が擦り減り、東海の水が枯れるその日まで、\n神が私たちの国を守り、守ってくださいますように。\nハイビスカスと三千里の素晴らしい山と川。\n韓国の人々よ、韓国のやり方に忠実であれ！"
  },
  "Spain": {
    "anthem": "Marcha Real",
    "native": "Marcha Real",
    ...
    "translation_ja": "スペインの国歌「マルカ・レアル」は、公式の歌詞がない世界でも数少ない国歌の 1 つです。過去にはさまざまな言葉が書かれてきましたが、現時点ではどれも正式なものではありません。"
  },
  "Sri Lanka": {
  ...
  "Sweden": {
    ...
    "translation_ja": "あなたは古代、あなたは自由、あなたは山岳地帯の北、\nあなたは静かで、あなたは楽しくて公正です！\n地球上で最も美しい土地よ、あなたに挨拶します。\nあなたの太陽、あなたの空、あなたの牧草地は緑です。"
  },
  "Switzerland": {
    "anthem": "Swiss Psalm",
    "native": "Swiss Psalm",
    ...
    "translation_ja": "朝の空が赤く染まる頃、\nそして彼らの輝きを私たちに与えてください、\n主よ、あなたは彼らの光の中に現れます。"
  },
  "Syria": {
    ...
    "translation_ja": "祖国の守護者よ、平安あれ\n私たちの誇り高い精神は不名誉を拒否します\nアラビズムの巣窟に、私たちは神聖な家を建てます\n死から守られた太陽の玉座。"
  },
  "Tajikistan": {
    "anthem": "Surudi Milli",
    "native": "Суруди Миллӣ",
  ...
  "Thailand": {
    ...
    "translation_ja": "タイはタイ人の血と生を結びつけるものです。\nタイの土地はタイ人のものです。\n長くその主権を維持してきました。"
  },
  "Tonga": {
  ...
  "Tunisia": {
    ...
    "translation_ja": "おお、祖国の擁護者たちよ！\n私たちの時代の栄光を目指して結集しましょう！\n私たちの血管に血液が急増し、\n私たちは土地のために死ぬのです。"
  },
  "Turkey": {
    ...
    "translation_ja": "恐れることはありません！この夜明けに誇らしげに羽ばたく深紅の旗は決して色褪せないから、\n私の国で燃えている最後の炉が消える前に。\nそれは私の国の星であり、永遠に輝くからです。\nそれは私のものであり、私の国家のみに属します。"
  },
  "Turkmenistan": {
    ...
    "translation_ja": "あなた、私の土地のために、私は自分の命を捧げる準備ができています。\n私たちの勇敢な先祖たちは心にスピリットを持っており、\nそれは中立独立の地の光です。"
  },
  "Ukraine": {
    ...
    "translation_ja": "ウクライナの栄光と意志はまだ消えていない、\nそれでも、兄弟たちよ、運命は再び微笑むでしょう。\n私たちの敵は太陽の露のように溶けて消えていきます。"
  },
  "United Arab Emirates": {
    ...
    "translation_ja": "祖国万歳、首長国の団結万歳。\nあなたはイスラム教を宗教とし、コーランを指針とする国家のために生きてきました。\n私は神の名の下にあなたを強くしました—ああ、祖国よ！"
  },
  "United Kingdom": {
    ...
    "translation_ja": "神よ、私たちの慈悲深い王を救いたまえ、\n私たちの高貴な王よ、長生きしてください。\n神よ王を救ってください！"
  },
  "United States": {
    ...
    "translation_ja": "ああ、わかるか、夜明けの早い光の中で、\n夕暮れの最後の輝きを私たちが誇らしげに称賛したのは何だったのでしょうか？\n危険な戦いを乗り越えたその幅広の縞模様と輝かしい星は、\n私たちが見ていた城壁は、こんなに勇敢に流れていたのですか？"
  },
  "Uruguay": {
    ...
    "translation_ja": "東洋人よ、祖国か、墓か！\n自由か栄光か死ね！\nそれは魂が宣言する誓いです、\nそして英雄的に、私たちはそれを実現する方法を知るでしょう。"
  },
  "Uzbekistan": {
    ...
    "translation_ja": "私の晴れた自由な土地、人々の幸福と救い、\nあなたは仲間であり、友達に優しいです！"
  },
  "Vietnam": {
    "anthem": "Tiến Quân Ca",
    "native": "Tiến Quân Ca",
